pub fn main() {
    println!("\n=== 18.1 patterns and matching | all the places patterns can be used ===\n");
...
fn let_pattern_match() {
    println!("\n-- lets are similar to Elixir's match operator `=`\n");
...
fn function_pattern_matching() {
    println!("\n-- function pattern matching (similar to functional langs)\n");
